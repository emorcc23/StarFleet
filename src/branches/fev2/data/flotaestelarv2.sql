...
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias10","charge10","gender10",10,"origin10","race10","image10",21);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias11","charge11","gender11",11,"origin11","race11","image11",20);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias12","charge12","gender12",12,"origin12","race12","image12",19);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias13","charge13","gender13",13,"origin13","race13","image13",18);
INSERT INTO tripulant(alias,charge,gender,experience,origen,race,age,image,id_ship)VALUES("alias14","charge14","gender14",14,"origin14","race14","image14",17);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias15","charge15","gender15",15,"origin15","race15","image15",16);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias16","charge16","gender16",16,"origin16","race16","image16",15);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias17","charge17","gender17",17,"origin17","race17","image17",14);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias18","charge18","gender18",18,"origin18","race18","image18",13);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias19","charge19","gender19",19,"origin19","race19","image19",12);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias20","charge20","gender20",20,"origin20","race20","image20",11);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias21","charge21","gender21",21,"origin21","race21","image21",10);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias22","charge22","gender22",22,"origin22","race22","image22",9);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias23","charge23","gender23",23,"origin23","race23","image23",8);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias24","charge24","gender24",24,"origin24","race24","image24",7);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias25","charge25","gender25",25,"origin25","race25","image25",6);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias26","charge26","gender26",26,"origin26","race26","image26",5);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias27","charge27","gender27",27,"origin27","race27","image27",4);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias28","charge28","gender28",28,"origin28","race28","image28",3);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias29","charge29","gender29",29,"origin29","race29","image29",2);
INSERT INTO tripulant(alias,charge,gender,experience,origin,race,age,image,id_ship)VALUES("alias30","charge30","gender30",30,"origin30","race30","image30",1);
