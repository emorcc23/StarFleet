...
public class RemoveLogbook extends javax.swing.JDialog {
      ...
      private void initComponents() {
            ...
            tableRemoveLogbooks = new javax.swing.JTable();
            ...
            jLabel2.setText("List all logbooks to remove");
            jPanel1.add(jLabel2);
            jLabel2.setBounds(300, 50, 290, 21);

            tableRemoveLogbooks.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 12)); // NOI18N
            tableRemoveLogbooks.setModel(new javax.swing.table.DefaultTableModel(
                  new Object [][] {
            ...
            jScrollPane1.setViewportView(tableRemoveLogbooks);
            if (tableRemoveLogbooks.getColumnModel().getColumnCount() > 0) {
                  tableRemoveLogbooks.getColumnModel().getColumn(0).setResizable(false);
                  tableRemoveLogbooks.getColumnModel().getColumn(1).setResizable(false);
                  tableRemoveLogbooks.getColumnModel().getColumn(2).setResizable(false);
                  tableRemoveLogbooks.getColumnModel().getColumn(3).setResizable(false);
                  tableRemoveLogbooks.getColumnModel().getColumn(4).setResizable(false);
            }
      ...
      public static void main(String args[]) {
            try {
                  ...
                  java.util.logging.Logger.getLogger(RemoveLogbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                  public void run() {
                        RemoveLogbook dialog = new RemoveLogbook(new javax.swing.JFrame(), true);
      ...
      private javax.swing.JTable tableRemoveLogbooks;
