...
//                  DaoShip.getInstance().fillList(tableListShips);
      ...
      private void initComponents() {
            ...
            tableListShips = new javax.swing.JTable();
            ...
            jLabel2.setText("List all ships");
            jPanel1.add(jLabel2);
            ...
            tableListShips.setModel(new javax.swing.table.DefaultTableModel(
                  ...
                  new String [] {
                        "ID of the ship", "Captain", "Name", "Register", "Type", "Image"
                  }
            ) {
            ...
            if (tableListShips.getColumnModel().getColumnCount() > 0) {
                  ...
                  tableListShips.getColumnModel().getColumn(1).setResizable(false);
                  tableListShips.getColumnModel().getColumn(2).setResizable(false);
                  tableListShips.getColumnModel().getColumn(3).setResizable(false);
                  tableListShips.getColumnModel().getColumn(4).setResizable(false);
                  tableListShips.getColumnModel().getColumn(5).setResizable(false);
            }
      ...
      public static void main(String args[]) {
            try {
                  ...
                  java.util.logging.Logger.getLogger(ListShip.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                  public void run() {
                        ListShip dialog = new ListShip(new javax.swing.JFrame(), true);
      ...
      private javax.swing.JTable tableListShips;
